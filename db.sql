...
-- Habilitando a imposição de restrições de chave estrangeira (OFF por padrão para
-- compatibilidade)
...
("OPT003", "Modelagem e simulação", 9, 3),
("OPT004", "Sistemas multimídia", 9, 3),
("OPT005", "Engenharia da usabilidade", 9, 3),
("OPT006", "Arquitetura de computadores", 9, 3),
("OPT007", "Sistemas de tempo real", 9, 3),
("OPT008", "Administração e gerência de redes", 9, 3),
("OPT009", "Computação móvel", 9, 3),
("OPT010", "Administração e organização empresarial", 9, 3),
("OPT011", "Sistemas de informação", 9, 3),
("OPT012", "Pesquisa operacional", 9, 3),
("OPT013", "Paradigmas de linguagens de programação", 9, 3),
("OPT014", "Empreendedorismo", 9, 3),
("OPT015", "Informática na educação", 9, 3),
("OPT016", "Língua brasileira de sinais (Libras)", 9, 3),
("OPT017", "Linguagem de descrição de hardware", 9, 3),
("OPT018", "Tópicos especiais em banco de dados", 9, 3),
("OPT019", "Tópicos especiais em inteligência artificial", 9, 3),
("OPT020", "Tópicos especiais em desenvolvimento web", 9, 3),
...
("OPT003", "Modelagem e simulação", 10, 3),
("OPT004", "Sistemas multimídia", 10, 3),
("OPT005", "Engenharia da usabilidade", 10, 3),
("OPT006", "Arquitetura de computadores", 10, 3),
("OPT007", "Sistemas de tempo real", 10, 3),
("OPT008", "Administração e gerência de redes", 10, 3),
("OPT009", "Computação móvel", 10, 3),
("OPT010", "Administração e organização empresarial", 10, 3),
("OPT011", "Sistemas de informação", 10, 3),
("OPT012", "Pesquisa operacional", 10, 3),
("OPT013", "Paradigmas de linguagens de programação", 10, 3),
("OPT014", "Empreendedorismo", 10, 3),
("OPT015", "Informática na educação", 10, 3),
("OPT016", "Língua brasileira de sinais (Libras)", 10, 3),
("OPT017", "Linguagem de descrição de hardware", 10, 3),
("OPT018", "Tópicos especiais em banco de dados", 10, 3),
("OPT019", "Tópicos especiais em inteligência artificial", 10, 3),
("OPT020", "Tópicos especiais em desenvolvimento web", 10, 3),
("OPT021", "Tópicos especiais em redes de computadores", 10, 3),
("OPT022", "Tópicos especiais em orientação a objetos", 10, 3),
("OPT023", "Tópicos especiais em sistemas operacionais", 10, 3),
("OPT024", "Tópicos especiais em qualidade de software", 10, 3),
("OPT025", "Tópicos especiais em segurança", 10, 3),
("OPT026", "Tópicos especiais em sistemas distribuídos", 10, 3),
("OPT027", "Tópicos especiais em jogos digitais", 10, 3),
("OPT028", "Tópicos em automação e controle", 10, 3),
("OPT029", "Tópicos especiais em engenharia de software", 10, 3);
